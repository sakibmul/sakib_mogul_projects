...
function success(pos) {
   ...
   L.marker([latitude, longitude], {icon: home}).addTo(myMap).bindPopup('You are here!');
...
$.ajax({
   ...
   success: function(result) {
      ...
      .addTo(myMap).bindPopup('<a href="https://' + result['data']['geonames'][i]['wikipediaUrl'] + '">' + result['data']['geonames'][i]['wikipediaUrl'] + '</a>');
      };
