        ...
        $('#departmentDependency').change(function () {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    for (let i = 0; i < result.data.length; i++) {
                        $('#departmentDisplay').append(
                        '<div class="col mb-4"><div class="card"><i class="fas fa-address-book fa-4x pt-2 m-auto"></i><div class="card-body"><h5 class="card-title text-center fw-bold fs-5">Employee</h5><table class="table"><tbody><tr><td class="text-center">' + result['data'][i]['lastName'] + ', ' + result['data'][i]['firstName'] + '</td></tr><tr><td class="text-center">' + result['data'][i]['email'] + '</td></tr></tbody></table></div></div></div>');
                    }// end of for loop
        ...
        $('#locationDependency').change(function () {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    for (let i = 0; i < result.data.length; i++)   {
                        $('#locationDisplay').append(
                        '<div class="col mb-4"><div class="card"><i class="fas fa-city fa-4x pt-2 m-auto"></i><div class="card-body"><h5 class="card-title text-center fw-bold fs-5">Department</h5><table class="table"><tbody><tr><td class="text-center">' + result['data'][i]['name'] + '</td></tr></tbody></table></div></div></div>');
                        }; // end of for loop
