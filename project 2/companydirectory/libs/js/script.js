...
if ($('#departmentEmps') != "Department") {
    ...
    $('#departmentEmps').change(function () {
        var depID = $('#departmentEmps option:selected').val();
        
        $.ajax({
            url: "libs/php/getPersonnelByDepID.php",
            type: "POST",
            dataType: "json",
            data: {
                departmentID: depID,
                ...
                $('#searchEmployeeBtn').click(function() {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            departmentID: $('#departmentEmps option:selected').val(),
                        },
                        success: function(result) {
                            console.log(result.data);
