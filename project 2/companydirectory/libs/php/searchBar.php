<?php
   ...
   if(isset($_REQUEST["dept"]) and strlen($_REQUEST["dept"]) > 0){
    ...
    if(isset($_REQUEST["loc"]) and strlen($_REQUEST["loc"]) > 0){
        ...
        $query = $query.' and l.name ='.'"'.$_REQUEST['loc'].'"';
    } 
